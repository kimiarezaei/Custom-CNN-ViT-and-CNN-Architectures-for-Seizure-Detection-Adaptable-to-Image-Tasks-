...
def train(model, params, train_loader, validation_loader, device):
    ...
    class_weights = torch.tensor(params.class_weights , dtype=torch.float).to(device)
    ...
    info_dict = {
        "arcitechture": params.architecture,
        "batch_size": params.batch_size,
        "epochs": params.epochs, 
        "learning_rate": params.learning_rate,
        "eta_min": params.eta_min,
        "warmup_period": params.warmup_period,
    ...
    return model, best_epoch, best_model, df
