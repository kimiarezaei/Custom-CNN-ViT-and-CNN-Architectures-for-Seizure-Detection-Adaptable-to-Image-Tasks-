...
from model import MyCNN, init_weights
...
parser.add_argument('--data_dir', 
                    default=rf"your directory/spectrograms", 
                    help='Directory containing data')

parser.add_argument('--info_dir', 
                    default=r'CNN\parameters/my_params.json',
                    help='Directory containing json file for hyperparameters')


parser.add_argument('--save_dir', 
                    default=rf'CNN\saved files\{today}',
